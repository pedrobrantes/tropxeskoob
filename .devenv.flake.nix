{
  ...
  devenv_root = "/home/brantes/tropxeskoob_rs";
  project_input_ref = "path:/home/brantes/tropxeskoob_rs";
  devenv_dotfile = "/home/brantes/tropxeskoob_rs/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/tmp";
  devenv_runtime = "/tmp/devenv-5016e80";
  ...
  hostname = "localhost";
  username = "brantes";
  git_root = "/home/brantes/tropxeskoob_rs";
  secretspec = null;
};
    in
    {
